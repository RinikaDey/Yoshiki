            ...
            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
              ...
              <form class="mx-1 mx-md-4" method="POST" action="{{ route('register') }}">
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                  ...
                  <div class="form-outline flex-fill mb-0">
                    <div class="position-relative">
                      <input type="password" id="password" class="form-control pe-5 @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" />
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                  ...
                  <div class="form-outline flex-fill mb-0">
                    <div class="position-relative">
                      <input type="password" id="confirmpassword" class="form-control pe-5" name="password_confirmation" required autocomplete="new-password"/>
                      <span class="toggle-password position-absolute top-50 end-0 translate-middle-y me-3"
