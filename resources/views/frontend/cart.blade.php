...
<div class="bg-light border rounded p-3 mb-3 shadow-sm mx-auto d-flex w-75">
    <h6 class="mb-0">
        <a href="{{url('/')}}">Home</a>/
...
<div class="container my-3 py-3">
    <div class="card shadow mycartitems ">
        ...
        <div class="card-body">
            ...
            <div class="row product_data border-bottom border-light my-4 d-flex justify-content-around align-items-center border border-primary border-dashed border-opacity-50" >
                <div class="col-md-2">
                    <img src="{{ $item->products->image_url }}" height="80px" width="90px" alt="Image Here">
                </div>
